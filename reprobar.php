...
if(isset($_SESSION['conectado']) && $_SESSION['conectado'] == "si") {
    ...
    $res = $dbcon -> query($sql);
//consulta si el alumno esta graduado
    ...
    //consulta si el alumno ya esta en una lista el proximo año
        ...
        //consulta lista actual en que se encuentra el alumno
            ...
            if($curso != $cur_actual){
                ...
                $sql4 = "INSERT INTO lista (id_curso, id_alumno, anio) 
                        values ($cur_actual,$alumno,YEAR(NOW())+1)";
                ...
                if($res4){
                    ...
                    echo";-1;No se pudo reprobar el alumno;";
                }
