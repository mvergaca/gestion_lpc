...
<head>
    ...
    <script>
        function ver_alumno(ref) {
            window.location.href = "ver_alumno_asi.php?id="+ref;
        }
    ...
    <div class="col-sm-offset-0 col-sm-12">
        <div class="col-sm-offset-2 col-sm-8" style='background-color: #f7ecb5;'>
            ...
            echo"<table class='table table-borderer table-responsive'>
                ...
                <tr>
                    ...
                    <td style='border: #34a9b6 2px solid;'><label>Obs</label></td>
                </tr>
                </thead>
                <tbody>";
        ...
        <tr>
            ...
            <td style='border: #34a9b6 2px solid;'>";
                ...
                <td style='border: #34a9b6 2px solid;'><input type='button' value='Obs' class='btn btn-info' onclick='obs_alumno($datos[id_alumno])'></td>
        </tr>
        ";
            }
