    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbar-collapse-1">
            ...
            <ul class="nav navbar-nav navbar-left navbar-header" style="margin-left: 3%">
                <li><a href="inicio_secretaria.php" style="color: #0f0f0f"><b>Inicio</b></a></li>
                ...
                <li class="dropdown" >
                    ...
                    <ul class="dropdown-menu">
                        ...
                        while($dato = mysqli_fetch_array($res)){
                            echo "
                            <li><a href='ver_curso_sec.php?curso=$dato[id_curso]'>$dato[nombre_curso]</a></li>
                            ";
                        }
                        $res->close();
                        ?>
                ...
                <li><a href="lista_profesores_sec.php" style="color: #0f0f0f"><b>Profesores</b></a></li>
